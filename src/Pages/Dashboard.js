  ...
  return (
    <>
      <div className="grid-01">
        <div className="card card1 bg-01 bg-02-shadow">
        ...
        <div className="card card2 bg-01 p-[10px]  bg-02-shadow flex-col">
          <div>
        ...
        <div className="card card3  bg-01 bg-02-shadow">
          <div className="card3">
            <div className="flex flex-col">
              ...
              <div style={{ marginTop: "30px" }} className="ml-[-20px] ">
                <Chart />
              </div>
            </div>
          </div>
        </div>
        <div className="card card4 bg-01 bg-02-shadow">
          <div className="flex justify-between p-[10px]">
            <div>
              ...
              <p className="text-29" style={{ marginTop: "40px" }}>
                <b>68.2%</b> more events than last month
              </p>
            </div>

            <div style={{ position: "relative" }} className="mt-[20px]">
              {<Circle />}
              <div
                style={{
                  position: "absolute",
        ...
        <div className="card card5 bg-01 bg-02-shadow">
          <UserTable />
        </div>
        <div className="card card6 bg-01 bg-02-shadow">
          <div className="flex flex-col">
